	...
	<div class="bg0 m-t-23 p-b-140">
		<div class="container">
			...
			<div class="row isotope-grid">
				...
				<div v-for="(p, i) in products" :key="i" class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					<!-- Block2 -->
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img :src="'http://127.0.0.1:8000/photos/products/' + p.photo.path" alt="IMG-PRODUCT">

							<a @click="getId(p.id)" href="#"
							...
							<div class="block2-txt-child2 flex-r p-t-3">
								<a href="#" class="btn-addwish-b2 dis-block pos-relative js-addwish-b2">
									<img class="icon-heart1 dis-block trans-04"
										src="@/assets/front-assets/images/icons/icon-heart-01.png" alt="ICON">
									<img class="icon-heart2 dis-block trans-04 ab-t-l"
										src="@/assets/front-assets/images/icons/icon-heart-02.png" alt="ICON">
								</a>
							</div>
						</div>
					</div>
