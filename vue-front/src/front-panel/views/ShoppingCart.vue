                ...
                <tr v-for="(p, i) in productsInCart" :key="i" class="table_row">
                  <td class="column-1">
                    <div class="how-itemcart1">
                      <img
                        :src="
                          'http://127.0.0.1:8000/photos/products/' +
                          p.photo.path
                        "
                        alt="IMG"
                      />
        ...
        <div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50">
          ...
          >
            ...
            <div class="flex-w flex-t bor12 p-t-15 p-b-30" v-show="pay > 0">
              <img
                class="img-fluid"
                src="@/assets/front-assets/images/bkash-payment.png"
                alt=""
              />
              <div v-show="pay == 1">
                <div class="mb-3">
                  <label for="exampleInputEmail1" class="form-label"
                    >Enter Your Bkash Number:</label
                  >
                  <input
                    type="email"
                    class="form-control"
