...
<template>
    ...
    <div class="card-body">
      <div class="mb-3">
            ...
            <input v-model="content_text" type="text" class="form-control" id="usage-count-input" placeholder="content here" />
      ...
      <div class="mb-3">
        ...
        <div class="mb-3">
            <label class="form-label" for="code-select">Product</label>
            <select id="code-select" class="form-select" v-model="product_id">
        ...
        <!-- <div class="mb-3">
              <input type="text" class="form-control" list="tt1" id="tt" v-model="product_id" placeholder="select products">
              <datalist id="tt1" >
                <option disabled value="">Select a product</option>
                <option v-for="(p, i) in products" :key="i" :value="p.id">{{ p.name }}</option>
              </datalist>
